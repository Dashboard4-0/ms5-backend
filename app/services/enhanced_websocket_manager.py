...
This module provides enhanced WebSocket management with production-specific
...
class EnhancedWebSocketManager:
    ...
    async def connect(self, websocket: Any, user_id: str) -> str:
        ...
        connection_id = f"{user_id}_{len(self.active_connections)}"
    ...
    def disconnect(self, connection_id: str):
        ...
        logger.info("Enhanced WebSocket connection closed", connection_id=connection_id)
    ...
    def subscribe_to_production_line(self, connection_id: str, line_id: str):
    ...
    def unsubscribe_from_production_line(self, connection_id: str, line_id: str):
    ...
    # Production-specific broadcasting methods
    ...
    async def broadcast_downtime_event(self, downtime_event: dict):
    ...
    async def broadcast_andon_event(self, andon_event: dict):
